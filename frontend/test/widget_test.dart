...
// This test file provides a minimal, self-contained widget test.
// It avoids importing the full app to prevent platform/plugin init issues
// when running widget tests.
